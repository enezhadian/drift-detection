...
public class MapDILCA {
    ...
    public static MapDILCA distanceMatrixFor(ImmutableList<ImmutableList<String>> database,
    ...
    private MapDILCA(Map<String, Map<String, Double>> distances) {
